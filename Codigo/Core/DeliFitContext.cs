...
public partial class DeliFitContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cartao>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdCarrinho, "fk_Cartao_Carrinho1_idx");
            ...
            entity.HasOne(d => d.IdCarrinhoNavigation).WithMany(p => p.Cartaos)
                .HasForeignKey(d => d.IdCarrinho)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("fk_Cartao_Carrinho1");
